 ...
 */
class ${Entityname}Attribute extends EavAttribute implements ScopedAttributeInterface
{
    /**
     * Constants
     */
    ...
    {
        $this->_init('${Vendorname}\${Modulename}\Model\ResourceModel\${Entityname}Attribute');
    }
